...
VkImageView Application::createImageView(VkImage img, VkFormat format, VkImageAspectFlags aspectFlags) {
...
VkFormat Application::findSupportedFormat(const std::vector<VkFormat>& candidates,
    ...
    throw std::runtime_error("failed to find suuported format!");
}
